        ...
        <Card title="API Connection">
          <div className="space-y-4">
            <label className="block">
              ...
              <input
                className="w-full rounded-md border border-[var(--border)] bg-[var(--field)] px-3 py-2 text-sm text-[var(--fg)] outline-none focus:border-[var(--accent)]"
                value={apiBaseUrl}
                onChange={(event) => {
                  setSaved(false);
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                className="rounded-md border border-[var(--accent)] bg-[var(--accent)] px-3 py-2 text-sm font-medium text-[var(--accent-fg)] hover:bg-[var(--accent-strong)]"
